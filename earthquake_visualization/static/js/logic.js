function clickListener() {
  ...
  function createMap(data, data2) {
    ...
    legend.onAdd = function () {
      ...
      div.innerHTML += "<i style='background: #E0AAFF'></i> 0 - 10<br>";
      div.innerHTML += "<i style='background: #C77DFF'></i> 10 - 30<br>";
      div.innerHTML += "<i style='background: #7B2CBF'></i> 30 - 50<br>";
      div.innerHTML += "<i style='background: #5A189A'></i> 50 - 70<br>";
      div.innerHTML += "<i style='background: #3C096C'></i> 70 - 90<br>";
      div.innerHTML += "<i style='background: #10002B'></i> 90+";
